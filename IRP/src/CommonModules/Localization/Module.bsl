Function Strings(Lang) Export
	...
	// %1 - en
	Strings.Insert("Error_005", NStr("fr='Complétez la description de l''attribut supplémentaire %1.';
	...
	Strings.Insert("Error_094", NStr("ru='Нельзя использовать подтверждение отправки товара без подтверждения о его получении. ';
	                                 |en='Сan not use confirmation of shipment without goods receipt'", Lang));
...
Procedure PredefinedDescriptions(Strings, CodeLanguage)
	...
	Strings.Insert("Description_A042", NStr("fr='Document Liste des prix';
